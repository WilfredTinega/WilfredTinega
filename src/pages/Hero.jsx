...
const Hero = () => {
  return (
    <div className='min-h-screen md:px-10 bg-gray-950 flex flex-col-reverse md:flex-row items-center justify-center gap-10'>
        <img className='w-50 h-50 md:w-75 md:h-75 lg:w-100 lg:h-100 rounded-full' src={Assests.wmt} alt="" />
        <div className='bg-white p-5 rounded-2xl shadow-md shadow-green-500 md:rounded-r-2xl'>
